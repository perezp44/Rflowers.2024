...
Me queda hacer el collage, será para otro día ....


Lo que sí voy a hacer es una tabla con links a las imagenes de las obras de Goya que hay en Wikidata. No todas las obras de Goya tienen una imagen en Wikidata, pero sí muchas de ellas, concretamente 482. Ahí van:  
...
DT::datatable(df_con_img,  
              caption = 'Cuadro 4: Imagén y links a las obras de Goya en Wikidata',
              filter = 'top',
              class = 'cell-border stripe',
              colnames = c("Cuadro", "Museo", "Ciudad", "Imagen en Wikidata", "Link a Wikipedia" , "Link a Wiki inglesa", "id", "Link a Wikidata"))
```

<br>

Me falta hacer que los hiperlinks de la tabla anterior funciones, que sean cliclables.
