...
- [Kaggle](https://www.kaggle.com/). Es una plataforma de competiciones de machine learning. Puedes encontrar datos, análisis y el código. Impresionante. Hay mucho código en R, pero digamos que es más territorio Phyton. Los datos [aquí](https://www.kaggle.com/datasets).
...
- **Banco Central Europeo**:  [ecb](https://cran.r-project.org/web/packages/ecb/index.html). No lo he usado.   [Aquí](https://data.ecb.europa.eu/) el portal de datos del BCE y [aquí](https://data.ecb.europa.eu/data/datasets) los datasets.


- [The World Bank](https://data.worldbank.org/). Los indicadores [aquí](https://data.worldbank.org/indicator). hay varios paquetes: [WDI](https://github.com/vincentarelbundock/WDI), [wbstats](https://github.com/gshs-ornl/wbstats). [Aquí](https://econandrew.github.io/wdi-api-R-gettingstarted/index.html) un bookdown sobre la API del Worls Bank.
...
- [UN comtrade database](https://comtradeplus.un.org/): datos detallados de comercio global. [Aquí](https://comtrade.un.org/data/Doc/api/ex/r) un post sobre cómo usar su API con R.
