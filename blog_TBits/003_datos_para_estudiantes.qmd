...
- [The World Bank](https://data.worldbank.org/). Los indicadores [aquí](https://data.worldbank.org/indicator). hay varios paquetes: [WDI](https://github.com/vincentarelbundock/WDI), [wbstats](https://github.com/gshs-ornl/wbstats) y [wordbankr](https://langcog.github.io/wordbankr/articles/wordbankr.html) [Aquí](https://econandrew.github.io/wdi-api-R-gettingstarted/index.html) un bookdown sobre la API del World Bank.
...
- [OpenLandMap](https://openlandmap.github.io/book/012-compendium.html) es un proyecto que hade un Compendium of Global Gridded Environmental Data Sets. Me entere por este [toot](https://fosstodon.org/@tomhengl/111654580107485689)
